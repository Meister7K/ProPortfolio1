...
function Support(props: any) {
  ...
  return (
    ...
    >
      ...
      <div className="mask">
        <p className="support-pl">
          {" "}
          feel free to support me on my journey into the field of web
          development!
        </p>
        ...
        <p className="support-pr">
          {" "}
          Welcome to my 2003 myspace page animation style
        </p>
      </div>
    </div>
  );
